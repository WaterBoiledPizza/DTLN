...
block_shift = 128
# load models
interpreter_1 = tflite.Interpreter(model_path='./models_DTLN_model_no_normalization_stateless/DTLN_model_no_normalization_stateless_1.tflite')
interpreter_1.allocate_tensors()
interpreter_2 = tflite.Interpreter(model_path='./models_DTLN_model_no_normalization_stateless/DTLN_model_no_normalization_stateless_2.tflite')
...
# write to .wav file
sf.write('./test/output/out_stateless.wav', out_file, fs)
